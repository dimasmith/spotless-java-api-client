...
import com.spotless.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw SpotlessInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw SpotlessInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }
