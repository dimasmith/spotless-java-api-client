...
import com.spotless.api.client.SpotlessClientImpl
...
/**
 * A class that allows building an instance of [SpotlessClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class SpotlessOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SpotlessClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): SpotlessClient = builder().fromEnv().build()
    }

    /** A builder for [SpotlessOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SpotlessClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpotlessClient =
            SpotlessClientImpl(
                clientOptions
                    .httpClient(
