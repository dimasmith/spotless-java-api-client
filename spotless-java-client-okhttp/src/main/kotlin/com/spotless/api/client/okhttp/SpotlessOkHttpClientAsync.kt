...
package com.spotless.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.spotless.api.client.SpotlessClientAsync
import com.spotless.api.client.SpotlessClientAsyncImpl
import com.spotless.api.core.ClientOptions
import com.spotless.api.core.Timeout
import com.spotless.api.core.http.Headers
import com.spotless.api.core.http.HttpClient
import com.spotless.api.core.http.QueryParams
import com.spotless.api.core.jsonMapper
...
/**
 * A class that allows building an instance of [SpotlessClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class SpotlessOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [SpotlessClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): SpotlessClientAsync = builder().fromEnv().build()
    }

    /** A builder for [SpotlessOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.spotless.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [SpotlessClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SpotlessClientAsync =
            SpotlessClientAsyncImpl(
                clientOptions
                    .httpClient(
