...
import com.spotless.api.client.okhttp.OkHttpClient
import com.spotless.api.core.RequestOptions
import com.spotless.api.errors.SpotlessRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw SpotlessRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            SpotlessRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
