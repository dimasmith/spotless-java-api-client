...
dependencies {
    testImplementation(project(":spotless-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../spotless-java-core/src/main/resources/META-INF/proguard/spotless-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../spotless-java-core/src/main/resources/META-INF/proguard/spotless-java-core.pro",
